...
HD_PWD='C:/Users/kbastola1/Desktop/Lab2C/Lab2C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2C.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_2C.tcl
