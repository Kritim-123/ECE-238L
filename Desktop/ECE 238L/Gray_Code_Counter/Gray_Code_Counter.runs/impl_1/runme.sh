...
HD_PWD='C:/Users/kbastola1/Desktop/Gray_Code_Counter/Gray_Code_Counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log grayCode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source grayCode.tcl -notrace
