...
HD_PWD='C:/Users/kbastola1/Desktop/Gray_Code_Counter/Gray_Code_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log grayCode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source grayCode.tcl
