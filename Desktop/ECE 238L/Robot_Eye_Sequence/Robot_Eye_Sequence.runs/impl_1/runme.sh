...
HD_PWD='C:/Users/kbastola1/Desktop/Robot_Eye_Sequence/Robot_Eye_Sequence.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Robot_Eye.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Robot_Eye.tcl -notrace
