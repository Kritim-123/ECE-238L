...
HD_PWD='C:/Users/kbastola1/Desktop/Robot_Eye_Sequence/Robot_Eye_Sequence.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Robot_Eye.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Robot_Eye.tcl
