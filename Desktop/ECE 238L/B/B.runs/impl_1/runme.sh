...
HD_PWD='C:/Users/kbastola1/Desktop/B/B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HexDisp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HexDisp.tcl -notrace
