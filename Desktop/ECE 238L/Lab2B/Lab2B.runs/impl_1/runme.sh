...
HD_PWD='C:/Users/kbastola1/Desktop/Lab2B/Lab2B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2B.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2B.tcl -notrace
