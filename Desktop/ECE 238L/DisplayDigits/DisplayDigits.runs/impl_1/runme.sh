...
HD_PWD='C:/Users/kbastola1/Desktop/DisplayDigits/DisplayDigits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log displayDigits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source displayDigits.tcl -notrace
