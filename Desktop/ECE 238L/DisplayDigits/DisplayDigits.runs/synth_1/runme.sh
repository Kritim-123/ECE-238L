...
HD_PWD='C:/Users/kbastola1/Desktop/DisplayDigits/DisplayDigits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log displayDigits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source displayDigits.tcl
