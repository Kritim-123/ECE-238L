...
HD_PWD='C:/Users/kbastola1/Desktop/oneHot/oneHot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oneHot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oneHot.tcl -notrace
