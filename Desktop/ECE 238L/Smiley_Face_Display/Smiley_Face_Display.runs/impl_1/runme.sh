...
HD_PWD='C:/Users/kbastola1/Desktop/Smiley_Face_Display/Smiley_Face_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SmileyFace.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SmileyFace.tcl -notrace
