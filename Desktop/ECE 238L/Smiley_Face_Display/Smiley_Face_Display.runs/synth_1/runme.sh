...
HD_PWD='C:/Users/kbastola1/Desktop/Smiley_Face_Display/Smiley_Face_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SmileyFace.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SmileyFace.tcl
