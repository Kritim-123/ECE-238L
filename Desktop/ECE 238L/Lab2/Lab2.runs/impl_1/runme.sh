...
HD_PWD='C:/Users/kbastola1/Desktop/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2A.tcl -notrace
