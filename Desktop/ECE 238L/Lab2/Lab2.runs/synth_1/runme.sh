...
HD_PWD='C:/Users/kbastola1/Desktop/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2A.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2A.tcl
