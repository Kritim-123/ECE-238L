...
HD_PWD='C:/Users/kbastola1/Desktop/TenState/TenState.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tenState.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tenState.tcl -notrace
