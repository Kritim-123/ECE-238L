...
HD_PWD='C:/Users/kbastola1/Desktop/TenState/TenState.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tenState.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tenState.tcl
